...
public class OrderNow extends JFrame {
    ...
    // ✅ Constructor with customer email
    public OrderNow(String customerEmail) {
        super("Order Now");
        this.customerEmail = customerEmail;
        initialize();
    }

    // ✅ Optional no-arg constructor for testing/fallback
    public OrderNow() {
        this("guest@clickbite.com"); // default guest email
    }
    ...
    private void initialize() {
        ...
        foodItemsMap.put("Best Sellers", Arrays.asList(
                ...
                new MenuItem("6pc Chickenjoy with Palabok Family Plan", 927,
                        "ClickBite/ClickBite_Images/Best_Sellers/Menu2.png"),
        ...
        foodItemsMap.put("Chicken & Platters", Arrays.asList(
                new MenuItem("1pc Chickenjoy with Burger Steak", 135,
                        "ClickBite/ClickBite_Images/ChickenPlatters/Menu1.png"),
                new MenuItem("1pc Chickenjoy with Creamy Macaroni Soup", 128,
                        "ClickBite/ClickBite_Images/ChickenPlatters/Menu2.png"),
                new MenuItem("1pc Chickenjoy with Double Rice", 143,
                        "ClickBite/ClickBite_Images/ChickenPlatters/Menu3.png"),
                new MenuItem("1pc Chickenjoy with Jolly Spaghetti", 135,
                        "ClickBite/ClickBite_Images/ChickenPlatters/Menu4.png"),
                new MenuItem("1pc Chickenjoy with Palabok", 205,
                        "ClickBite/ClickBite_Images/ChickenPlatters/Menu5.png"),
                new MenuItem("4pc Chickenjoy Family Box", 338,
                        "ClickBite/ClickBite_Images/ChickenPlatters/Menu6.png")));
    ...
    private void showFoodItems(String category) {
        ...
        for (MenuItem item : items) {
            ...
            for (int i = 1; i <= 10; i++)
                qtyChoice.add(String.valueOf(i));
    ...
    private void addToCart(String category, MenuItem item, int quantity) {
        ...
        if (customerEmail != null && !customerEmail.isEmpty()) {
            DatabaseManager.saveOrder(customerEmail, item.name, quantity, item.price);
        }
    }
    ...
    public static void main(String[] args) {
        new OrderNow("guest@clickbite.com");
    }
}
